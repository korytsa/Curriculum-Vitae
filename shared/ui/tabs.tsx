...
import { useLocale, useRippleCleanup, createRipple, scrollToTab } from "./utils";
...
const Tabs = forwardRef<HTMLDivElement, TabsProps>(
	({ items, activeTabId, defaultActiveTabId, className, onTabChange }) => {
		...
		const handleTabClick = (item: TabItem, event: React.MouseEvent<HTMLAnchorElement>) => {
		...
		return (
			<div ref={containerRef} className={cn("relative flex overflow-x-auto", className)}>
				{items.map((item) => {
