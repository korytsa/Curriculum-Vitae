...
export type CvProjectFieldsFragment = {
  __typename: "CvProject";
  id: string;
  name: string;
  ...
  roles: Array<string>;
  project: { __typename: "Project"; id: string; name: string; internal_name: string };
};
...
export type CvsQuery = {
  __typename: "Query";
  cvs: Array<{ __typename: "Cv"; id: string; name: string; education?: string | null; description: string; user?: { __typename: "User"; id: string; email: string } | null }>;
};
...
export type CvQuery = {
  ...
  cv: {
    ...
    description: string;
    languages: Array<{ __typename: "LanguageProficiency"; name: string; proficiency: Proficiency }>;
    skills: Array<{ __typename: "SkillMastery"; name: string; mastery: Mastery; categoryId?: string | null }>;
    projects?: Array<{
      __typename: "CvProject";
      id: string;
      name: string;
    ...
    user?: {
      ...
      profile: { __typename: "Profile"; full_name?: string | null; first_name?: string | null; last_name?: string | null; avatar?: string | null };
    } | null;
  };
  skillCategories: Array<{ __typename: "SkillCategory"; id: string; name: string; order: number; parent?: { __typename: "SkillCategory"; id: string; name: string } | null }>;
};
...
export type LanguagesWithProfileQuery = {
  __typename: "Query";
  languages: Array<{ __typename: "Language"; id: string; name: string } | null>;
  profile: { __typename: "Profile"; id: string; languages: Array<{ __typename: "LanguageProficiency"; name: string; proficiency: Proficiency }> };
};
...
export type AddProfileLanguageMutation = {
  __typename: "Mutation";
  addProfileLanguage: { __typename: "Profile"; id: string; languages: Array<{ __typename: "LanguageProficiency"; name: string; proficiency: Proficiency }> };
};
...
export type DeleteProfileLanguageMutation = {
  __typename: "Mutation";
  deleteProfileLanguage: { __typename: "Profile"; id: string; languages: Array<{ __typename: "LanguageProficiency"; name: string; proficiency: Proficiency }> };
};
...
export type SkillsWithCategoriesQuery = {
  __typename: "Query";
  skillCategories: Array<{ __typename: "SkillCategory"; id: string; name: string; order: number; parent?: { __typename: "SkillCategory"; id: string; name: string } | null }>;
  skills: Array<{ __typename: "Skill"; id: string; name: string; category?: { __typename: "SkillCategory"; id: string; name: string } | null }>;
  profile: { __typename: "Profile"; id: string; skills: Array<{ __typename: "SkillMastery"; name: string; categoryId?: string | null; mastery: Mastery }> };
};
...
export type AddProfileSkillMutation = {
  __typename: "Mutation";
  addProfileSkill: { __typename: "Profile"; id: string; skills: Array<{ __typename: "SkillMastery"; name: string; categoryId?: string | null; mastery: Mastery }> };
};
...
export type DeleteProfileSkillMutation = {
  __typename: "Mutation";
  deleteProfileSkill: { __typename: "Profile"; id: string; skills: Array<{ __typename: "SkillMastery"; name: string; categoryId?: string | null; mastery: Mastery }> };
};
...
export type UpdateSkillMutation = {
  __typename: "Mutation";
  updateSkill: { __typename: "Skill"; id: string; name: string; category?: { __typename: "SkillCategory"; id: string; name: string } | null };
};
...
export type UsersQuery = {
  ...
  users: Array<{
    ...
    department_name?: string | null;
    position_name?: string | null;
    profile: { __typename: "Profile"; id: string; first_name?: string | null; last_name?: string | null; avatar?: string | null };
...
export type UserDirectoriesQuery = {
  __typename: "Query";
...
export type UpdateProfileMutation = {
  __typename: "Mutation";
  updateProfile: { __typename: "Profile"; id: string; first_name?: string | null; last_name?: string | null; avatar?: string | null };
};
